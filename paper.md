...
Regarding the unobscured Lyα line profiles, `zELDA` includes an MCMC algorithm powered by the python package `EMCEE` 
...
```python
    ...
    plt.plot( w_SOL_pix_Arr , f_SOL_pix_Arr , label='Reconstruction' )
    plt.legend(loc=0)
